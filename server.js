...
app.put('/api/profile', requireAuth, async (req, res) => {
  ...
  if(displayName.length<2||displayName.length>60||preferredName.length>40||!['hu','en','uk'].includes(language)||!['default','gentle','bright','custom','pop','chime','joy','whistle'].includes(reminderSound))return res.status(400).json({error:'Érvénytelen profiladatok.'});
